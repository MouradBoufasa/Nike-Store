               ...
               <div className="">
                  ...
                  <div className=" flex items-center justify-between w-28 my-3">
                     <div className=" flex items-center bg-white/80 px-1 rounded blur-effect-theme">
                        <h1 className="text-black texts-sm font-medium ">
                           ${price}
                        </h1>
                     </div>
                  ...
                  <div className=" flex items-center gap-3">
                     ...
                     <button
                        type="button"
                        className="bg-white/90 blur-effect-theme button-theme px-2 py-1 shadow shadow-slate-200 texts-sm text-black">
                        {btn}
                     </button>
                  </div>
               </div>
